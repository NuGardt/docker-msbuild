...
LABEL lastupdate "2018-02-03"; \
LABEL version "2018.02.03"; \
LABEL author "Kevin Gardthausen"; \
LABEL vendor "NuGardt Software UG (haftungsbeschränkt)"; \
LABEL homepage "http://www.nugardt.com;" \
LABEL description "Microsoft .NET Build Tools 2017 (v15.5) with NuGet v4.5.0, Web Deploy v3.5, Developer Packs v4.5.2, 4.6.2, v4.7.0 and .Net Core v1.1.7 and v2.1.4 SDK."; \
